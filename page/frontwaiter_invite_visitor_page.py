...
class FronWaiterInviteVisitorPage(object):
    def __init__(self,driver):
        self.fe = FindElement(driver)
    def get_visitor_menu(self):
        return self.fe.get_element('visitor_module')
    def get_visitor_list(self):
        return self.fe.get_element('visitor_sign_list')
    def get_sign_addbtn(self):
        return self.fe.get_element('visitor_sign_addbtn')
    ...
    def get_visitor_approval(self):
        return self.fe.get_element('visitor_approval')
